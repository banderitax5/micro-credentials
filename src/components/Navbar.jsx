        ...
        <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
          <div className="flex lg:flex-1">
            <a href="/" className="-m-1.5 p-1.5">
              ...
              <img src="https://upload.wikimedia.org/wikipedia/commons/e/e2/RecoveryLogo.png" alt="" className="h-8 w-auto" />
            </a>
          </div>
          ...
          <el-popover-group className="hidden lg:flex lg:gap-x-12">
            <div className="relative">
              <button popoverTarget="desktop-menu-product" className="flex items-center gap-x-1 text-sm/6 font-semibold transition ease-in-out text-white hover:text-red-500">
                Shop
              </button>
            ...
            <HeaderNavLink to="/" linkLabel="Home"/>
            <a href="#" className="text-sm/6 font-semibold text-white transition ease-in-out duration-200 hover:text-red-500">Lyrics</a>
            <a href="#" className="text-sm/6 font-semibold text-white transition ease-in-out duration-200 hover:text-red-500">About</a>
          </el-popover-group>
          <div className="hidden lg:flex lg:flex-1 lg:justify-end">
            <HeaderNavLink to="/register" linkLabel="Register" />
