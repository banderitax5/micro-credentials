      ...
      <header class="bg-gray-900">
        <nav aria-label="Global" class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
          ...
          <el-popover-group class="hidden lg:flex lg:gap-x-12">
            ...
            <a href="#" class="text-sm/6 font-semibold text-white transition ease-in-out duration-200 hover:text-red-500">Videos</a>
            <a href="#" class="text-sm/6 font-semibold text-white transition ease-in-out duration-200 hover:text-red-500">Lyrics</a>
            <a href="#" class="text-sm/6 font-semibold text-white transition ease-in-out duration-200 hover:text-red-500">About</a>
          </el-popover-group>
          <div class="hidden lg:flex lg:flex-1 lg:justify-end">
            <a href="/" class="text-sm/6 font-semibold text-white hover:text-red-500" onClick={handleRegister}>Register <span aria-hidden="true">&rarr;</span></a>
          </div>
        </nav>
        <el-dialog>
